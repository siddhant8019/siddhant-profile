    ...
    <main className="px-4 py-8 max-w-4xl mx-auto">
      ...
      <div className="space-y-12">
        {projectsData.map((project, index) => (
          <div
            key={project.slug}
            className="bg-white p-6 rounded-lg border border-[#dae2e2]"
          >
            <div className="mb-4">
              <h2 className="text-xl sm:text-2xl font-bold text-[#000000] mb-2">
                {project.name}
              </h2>
              <p className="text-base sm:text-lg text-[#000000]/70">
                {project.tagline}
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div>
                <h3 className="text-base sm:text-lg font-semibold text-[#000000] mb-2">
                  Problem
                </h3>
            ...
            <div className="mb-4">
              <h3 className="text-base sm:text-lg font-semibold text-[#000000] mb-3">
                Stack
              </h3>
              <div className="flex flex-wrap gap-2">
                {project.stack.map((tech, techIndex) => (
                  <span
                    key={techIndex}
                    className="bg-[#dae2e2] text-[#000000] px-2 sm:px-3 py-1 text-xs sm:text-sm rounded-full"
                  >
                    {tech}
                  </span>
                ))}
