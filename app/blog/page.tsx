    ...
    <main className="px-4 py-8 max-w-4xl mx-auto">
      ...
      <div className="space-y-6">
        {portfolioData.blog.map((post, index) => (
          ...
          >
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-[#000000] mb-3">
              {post.title}
            </h2>
      ...
      <div className="text-center mt-12">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-3 bg-[#000000] text-[#f6f9f1] px-6 py-3 sm:px-8 sm:py-4 rounded-full hover:bg-[#000000]/90 transition-colors border border-[#dae2e2] text-base sm:text-lg"
        >
