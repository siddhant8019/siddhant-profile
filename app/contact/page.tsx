...
export default function Contact() {
  return (
    <main className="px-4 py-8 max-w-4xl mx-auto">
      ...
      <div className="bg-white p-6 rounded-lg border border-[#dae2e2]">
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <h2 className="text-xl sm:text-2xl font-semibold text-[#000000] mb-6">
              Get in touch
            </h2>
            ...
            <div className="space-y-4">
              <a
                href="/mail"
                className="flex items-center gap-3 text-[#000000]/80 hover:text-[#000000] transition-colors group"
              >
                <div className="p-2 bg-[#dae2e2] rounded-lg group-hover:bg-[#dae2e2]/80 transition-colors">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-[#dae2e2]/20 rounded-lg">
                <h3 className="text-sm sm:text-base font-semibold text-[#000000] mb-2">
                  Backend & Systems
                </h3>
