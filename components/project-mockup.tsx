...
export default function ProjectMockup({
  ...
  const renderCybersecurityMockup = () => (
    <div className="bg-white p-4 rounded-lg border border-[#dae2e2] shadow-lg">
      ...
      <div className="space-y-3">
        <div className="bg-[#f6f9f1] p-3 rounded border-l-4 border-red-500">
          ...
          <div className="text-xs text-[#000000]/70 mt-1">
            Suspicious login attempt from 192.168.1.100
          </div>
        </div>

        <div className="bg-[#f6f9f1] p-3 rounded border-l-4 border-yellow-500">
          <div className="flex items-center justify-between">
            <div className="text-sm font-medium text-[#000000]">
              ⚠️ Warning
            </div>
        ...
        <div className="bg-[#f6f9f1] p-3 rounded border-l-4 border-green-500">
          <div className="flex items-center justify-between">
            <div className="text-sm font-medium text-[#000000]">
              ✅ Normal
            </div>
      ...
      <div className="mt-4 flex justify-between text-xs text-[#000000]/70">
  ...
  const renderDocumentQAMockup = () => (
    <div className="bg-white p-4 rounded-lg border border-[#dae2e2] shadow-lg">
      ...
      <div className="space-y-3">
        <div className="bg-[#f6f9f1] p-3 rounded">
          <div className="text-sm font-medium text-[#000000] mb-2">
            📄 Upload Document
          </div>
          <div className="border-2 border-dashed border-[#dae2e2] p-2 rounded text-center text-xs text-[#000000]/70">
            Drag & drop PDF here
          </div>
        </div>
